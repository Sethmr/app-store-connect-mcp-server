...
import { AppStoreConnectClient, resolveConfig } from './services/index.js';
import { 
  AppHandlers, 
  BetaHandlers, 
  BundleHandlers, 
...
// Resolve credentials from the macOS Keychain (preferred) or env vars.
// See src/services/credentials.ts.
const config: AppStoreConnectConfig = resolveConfig();
